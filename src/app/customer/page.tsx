          ...
          <div className="bg-white rounded-lg shadow-lg p-12 space-y-6 max-w-2xl mx-auto">
            ...
            <div className="pt-6 space-y-4">
              <p className="text-gray-700">
                This is your customer dashboard. Here you can:
              </p>
              <ul className="text-left space-y-2 text-gray-600 bg-green-50 p-6 rounded-lg">
                <li className="flex items-center gap-2">
                  <span className="text-green-600">✓</span> Browse medicines
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-600">✓</span> Find nearby
                  pharmacies
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-600">✓</span> Check medicine
                  prices
                </li>
                <li className="flex items-center gap-2">
                  <span className="text-green-600">✓</span> Manage your orders
                </li>
              </ul>
            </div>
