  ...
  return (
    <div className="relative container mx-auto px-5 flex flex-col lg:flex-row items-center justify-between min-h-[100vh] lg:gap-8">
      ...
      >
        ...
        >
          Connect with{" "}
          <span className="font-semibold text-primary">nearby pharmacies</span>,
          compare{" "}
          <span className="font-semibold text-[#4FAA84]">
            availability & prices
          </span>
          , and get your medicines{" "}
          <span className="font-semibold text-green-600">faster</span>.
        </motion.p>
